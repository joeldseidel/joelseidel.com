            ...
            <>
                <ColumnContainer>
                    <TextColumn>
                        ...
                        <p>He is a 1 year old black labrador from Philadelphia, PA</p>
                        <ContentHeader>
                            <h1 class="font-title">What does he do?</h1>
                        </ContentHeader>
                        <h3 class="font-title">Eat</h3>
                        <p>Frank will consume nearly any material whether it resembles something edible or not. He is on a mission to remove every chicken bone from the streets of Philadelphia by eating them. He is truly a philanthropic hero for this.</p>
                        ...
                        <p>In the 6-10 hours a day he is awake, Frank can usually be found guarding the vicinity of 63rd & Market St from a strategically selected location on our porch. The neighborhood can be confident that no stray cats will go un-barked at. Frank has become a folk hero of sorts in the area.</p>
                    </TextColumn>
                    <PhotoColumn>
                        <Container>
                            <TitleContainer>
